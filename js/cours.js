...
req.open("GET", "http://localhost/wampserver/langages.txt");
...
/* EX GET FILM */
ajaxGet("http://localhost/wampserver/films.json", function (reponse) {
...
ajaxGet("http://localhost:8000/wampserver/langages.txt", afficher);
